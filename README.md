# Xuanjian Immortal Clan (玄鉴仙族) - English Translation

<p align="center">
  <img src="./assets/The%20Mirror%20Legacy%20(Cover).jpg" alt="The Mirror Legacy (Cover)" width="300">
</p>

Welcome to the unofficial fan translation repository for **Xuanjian Immortal Clan**! This project is focused on providing high-quality English translations of the novel.
...
- **Volume 1:** Ongoing
- **Volume 2:** Not Started
- **Volume 3:** Not Started
- **Volume 4:** Not Started
- **Volume 5:** Not Started
- **Volume 6:** Complete
- **Volume 7:** Complete
- **Volume 8:** Caught up with author.
...
1.  Navigate to the [**Releases Page**](https://github.com/ThunderGod95/XuanjianImmortalClan/releases).
2.  Find the release you want to download (e.g., `Volume 1`).
...
- **Discord Server (Preferred):** You can join **[Xuanjian Immortal Clan Discord Server (Unofficial)](https://discord.gg/mirrorlegacy)** and report the issue in the appropriate channel.
- **GitHub Issues:** Another way for us to track bugs is by [**opening an Issue**](https://github.com/ThunderGod95/XuanjianImmortalClan/issues) directly in this repository.

When reporting an issue (on either platform), please try to:

- Use a clear title or summary (e.g., "Typo in V6, Chapter 1301").
...
1.  [Open an Issue](https://github.com/ThunderGod95/XuanjianImmortalClan/issues) to discuss the term.
2.  Discuss it on the [Discord Server](https://discord.gg/mirrorlegacy).
...
This is a **fan translation** project. All copyrights for _Xuanjian Immortal Clan_ belong to the original author, **Ji Yueren (季越人)**. The translation is done by fans for fans and is not for any commercial purpose.
